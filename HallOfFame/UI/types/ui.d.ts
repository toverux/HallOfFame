declare module "cs2/ui" {
  ...
  export const Tooltip: ({ tooltip, disabled, theme, direction, alignment, className, children }: PropsWithChildren<TooltipProps>) => JSX.Element;
  ...
  export const Dropdown: ({ focusKey, initialFocused, theme: partialTheme, content, children }: PropsWithChildren<DropdownProps>) => JSX.Element;
  export interface DropdownToggleProps extends DropdownToggleBaseProps {
  	theme?: DropdownToggleTheme;
  }
  export const DropdownToggle: ({ theme, children, ...props }: PropsWithChildren<DropdownToggleProps>) => JSX.Element;
   ...
   */
  export function DropdownItem<T>({ focusKey, value, selected, theme, sounds, className, onChange, onToggleSelected, closeOnSelect, children }: PropsWithChildren<DropdownItemProps<T>>): JSX.Element;
  ...
  export const Icon: ({ tinted, className, src }: IconProps) => JSX.Element;
  ...
  export const FormattedText: ({ focusKey, text, theme: partialTheme, renderer, className, onLinkSelect, ...props }: FormattedTextProps) => JSX.Element;
  ...
  export const FormattedParagraphs: ({ focusKey, text, theme: partialTheme, renderer, className, children, onLinkSelect, maxLineLength, splitLineLength, ...props }: PropsWithChildren<FormattedParagraphsProps>) => JSX.Element;
