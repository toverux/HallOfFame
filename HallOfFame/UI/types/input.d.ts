declare module "cs2/input" {
  ...
  export function useElementFocusController(focusKey: UniqueFocusKey | null, elementRef: React$1.RefObject<HTMLElement | SVGElement | null>, activation?: FocusActivation, allowChildren?: boolean): ElementFocusController;
   ...
   */
  export const AutoNavigationScope: ({ focusKey, initialFocused, direction, activation, children, onChange, onRefocus, allowFocusExit, forceFocus }: React$1.PropsWithChildren<AutoNavigationScopeProps>) => JSX.Element;
   ...
   */
  export const FocusBoundary: ({ disabled, children, onFocusChange }: React$1.PropsWithChildren<FocusBoundaryProps>) => JSX.Element;
  ...
  export function useFocusChangeListener<T>(parser: KeyParser<T>, onChange: ChangeCallback<T>): FocusChangeListener;
  export function useEntityFocusChangeListener(onChange: ChangeCallback<Entity>): FocusChangeListener;
  export function useStringFocusChangeListener(onChange: ChangeCallback<string>): FocusChangeListener;
  export interface FocusDisabledProps {
  	disabled?: boolean;
  }
  export const FocusDisabled: ({ disabled, children }: React$1.PropsWithChildren<FocusDisabledProps>) => JSX.Element;
  export enum UISound {
   ...
   */
  export const PassiveFocusDiv: (props: PassiveFocusDivProps & React$1.RefAttributes<HTMLDivElement>) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>> | null;
   ...
   */
  export const ActiveFocusDiv: (props: ActiveFocusDivProps & React$1.RefAttributes<HTMLDivElement>) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>> | null;
  export function useFocused(focusController: FocusController): boolean;
  export function useFocusedRef(focusController: FocusController): React$1.RefObject<boolean>;
   ...
   * The component itself cannot be focused, it purely acts as a wrapper around a focusable child.
   */
  export const FocusKeyOverride: ({ focusKey, children }: React$1.PropsWithChildren<FocusKeyOverrideProps>) => JSX.Element;
  export interface FocusNodeProps {
  	controller: FocusController;
  }
  export const FocusNode: ({ controller, children }: React$1.PropsWithChildren<FocusNodeProps>) => JSX.Element;
  export const FocusRoot: ({ children }: React$1.PropsWithChildren) => JSX.Element;
   ...
   */
  export const FocusScope: ({ focusKey, debugName, focused, activation, children }: React$1.PropsWithChildren<FocusScopeProps>) => JSX.Element;
   ...
   * Optionally, a `focusKey` for the component itself can be set.
   */
  export const NavigationScope: ({ focusKey, debugName, focused, direction, activation, children, onChange, onRefocus, allowFocusExit, }: React$1.PropsWithChildren<NavigationScopeProps>) => JSX.Element;
  ...
  export const SelectableFocusBoundary: ({ children }: React$1.PropsWithChildren) => JSX.Element;
  ...
  export const InputActionHints: React$1.FC<InputActionHintsProps>;
  export interface ControlIconProps {
  	path: string;
  	modifier?: boolean;
  }
  export const ControlIcon: React$1.FC<ControlIconProps>;
  export const ActionHintLayout: ({ children, className, ...props }: ButtonProps) => JSX.Element;
  export function useInputControlIcon(path: string): string | null;
  ...
  export function gamepadButtonFromString(name: string): GamepadButton$1 | undefined;
  ...
  export const EventInputProvider: ({ children }: React$1.PropsWithChildren) => JSX.Element;
  export const GamepadPointerEventProvider: ({ children }: React$1.PropsWithChildren) => JSX.Element;
  export const NativeInputProvider: ({ children }: React$1.PropsWithChildren) => JSX.Element;
  ...
  export const InputActionBarrier: React$1.NamedExoticComponent<React$1.PropsWithChildren<InputActionBarrierProps>>;
  export interface InputActionConsumerProps {
  	actions: InputActions | null;
  	disabled?: boolean;
  }
  export const InputActionConsumer: React$1.NamedExoticComponent<React$1.PropsWithChildren<InputActionConsumerProps>>;
  export interface SingleActionConsumerProps {
  	disabled?: boolean;
  	onAction?: () => void;
  }
  /** When the Gamepad "A" button is pressed */
  export const SelectConsumer: ({ disabled, children, onAction }: React$1.PropsWithChildren<SingleActionConsumerProps>) => JSX.Element;
  export interface ExpandConsumerProps extends SingleActionConsumerProps {
  	expanded: boolean;
  	expandable: boolean;
  }
  /** When the Gamepad "X" button is pressed */
  export const ExpandConsumer: ({ expanded, expandable, disabled, children, onAction }: React$1.PropsWithChildren<ExpandConsumerProps>) => JSX.Element;
  /** When the Keyboard "ESC" or Gamepad "B" button is pressed */
  export const BackConsumer: ({ disabled, children, onAction }: React$1.PropsWithChildren<SingleActionConsumerProps>) => JSX.Element;
  ...
  export function setInputActionPriority(index: number, priority: number): void;
